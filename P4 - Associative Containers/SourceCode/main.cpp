...
int main()
{
  try
  {
    ...
    ///////////////////////// TO-DO (2) //////////////////////////////
      ...
      ///
    Bookstore::ShoppingCarts carts = bookstore.makeShoppingCarts();
    /////////////////////// END-TO-DO (2) ////////////////////////////
    ...
    ///////////////////////// TO-DO (3) //////////////////////////////
      ...
      ///
    Bookstore::BooksSold sales = bookstore.processCustomerShoppingCarts( carts );
    /////////////////////// END-TO-DO (3) ////////////////////////////
    ...
    ///////////////////////// TO-DO (4) //////////////////////////////
      ...
      /// inventory.
      ///
    Bookstore::Inventory_DB & inv = bookstore.inventory();
